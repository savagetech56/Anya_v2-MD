...
const number = Number(num[0]);
    ...
    switch (id) {
        ...
        case '05': {
            ...
            */
        case '48': {
            const hanimeUrls = message.match(/https?:\/\/(?:www\.)?hanime\.tv\/videos\/hentai\/[a-zA-Z0-9-]+/g) || [];
            const link = hanimeUrls[number -1];
            if (link !== undefined) cmd = `${prefix}hanimetvdl ${link}`;
            else cmd = `_404`;
    }
    break;
