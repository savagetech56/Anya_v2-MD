...
${cpt.join("\n")}
\`\`\`
        `.trim();// console.log(download.url);
        const headers = {
  'Accept': '*/*',
  'Accept-Encoding': 'gzip, deflate, br',
  'Accept-Language': 'en-US,en;q=0.9',
  'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8',
  'Cookie': '_ga=GA1.1.1639654056.1731144003; _ga_J3T7KLRQD3=GS1.1.1731144003.1.1.1731144203.0.0.0',
  'Origin': 'https://in-y2mate.com',
  'Referer': 'https://in-y2mate.com/',
  ...
  'X-Requested-With': 'XMLHttpRequest'
        ...
        let buffer = Buffer.isBuffer(download.video) ? download.video : await getBuffer(download.video, { headers });
        console.log(buffer);
        if (ui.buttons) {
